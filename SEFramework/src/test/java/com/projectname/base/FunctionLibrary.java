...
public class FunctionLibrary {
	...
	/***********************************************************************************************************
	 * Description	:	Launching different browser like... IE, FireFox, Chrome... etc..
	 * Created by	:	Santhosh R
	 * Created Date	:	10-Oct-2013
	 * Updated by	:	Santhosh R
	 * LastUpdated	: 
	...
	public void openBrowser() throws Exception {
		...
		for (int i = 1; i < tdsheet.getRows(); i++)
		{
			...
			case "BST":
				...
				break;
			case "RDC":
				if(browser.equalsIgnoreCase("RDC") && run.equalsIgnoreCase("Y")){
					String surl = tdsheet.getCell(7,i).getContents();
					DesiredCapabilities capabilities =DesiredCapabilities.firefox();
					capabilities.setJavascriptEnabled(true);
					WebDriver driver = new RemoteWebDriver(new URL("http://198.66.27.209:4444/wd/hub"), capabilities);
					driver.get(siteurl);
				}
				break;
			case "MFP":
	...
	/***********************************************************************************************************
	 * Description	:	Browser launches in Remote location and Execute the Scripts
	 * Created by	:	Santhosh R
	 * Created Date	:	10-Oct-2013
	 * Updated by	:	Santhosh R
	 * LastUpdated	: 
